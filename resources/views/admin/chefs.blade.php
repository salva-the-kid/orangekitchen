  ...
  <body class="bg-dark">
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active" ><a href="{{url('chefs')}}"> <i class="icon-padnote"></i>Add Chefs </a></li>
   ...
   <!-- <div class="d-grid gap-2">
     <a href="{{url('make_reservations')}}"><button style="height:7vh;margin:2vw;" type="button" name="" id="" class="btn btn-primary">Back</button></a>
      ...
      <form style="margin-left:10vw;margin-top:5vh;height:60vh;" method="POST" action="{{url('upload_chefs')}}" class="p-4 p-md-5 border rounded-3 bg-dark" enctype="multipart/form-data" >

                @csrf
             
                <div class="form-floating mb-3">
                <input type="name" name="name" class="form-control" id="floatingInput" placeholder="name@example.com" required>
              ...
              <!-- <div class="flex"> -->
              <div class="form-floating mb-3">
                <input type="text" name="specialty" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                <label style="color:black !important" for="floatingInput">Specialty</label>
              </div>
              <div class="form-floating mb-3">
                <input type="text" name="qualifications" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                <label style="color:black !important" for="floatingInput">Qaulifications</label>
              </div>
              <div class="form-floating mb-3">
                <input type="file" name="image" class="form-control" id="floatingInput" placeholder="" required>
                <label style="color:black !important" for="floatingInput">Chef Image</label>
              </div>
